...
public class HistoryAdapter extends BaseExpandableListAdapter {
    ...
    private List<HistoryItems> listDataHeader;
    private HashMap<String, List<String>> listDataChild;
    private SparseBooleanArray mSelectedItemsIds;
    boolean englishMalayalam;

    public HistoryAdapter(Context context, List<HistoryItems> listDataHeader,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        HistoryItems historyItems= (HistoryItems) getGroup(groupPosition);
        String headerTitle =  historyItems.getName();
        if (convertView == null) {
    ...
    public void remove(HistoryItems object) {
