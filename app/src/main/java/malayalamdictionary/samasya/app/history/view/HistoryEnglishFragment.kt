...
import malayalamdictionary.samasya.app.history.view.adapter.HistoryAdapter
import malayalamdictionary.samasya.app.database.DatabaseHelper
import malayalamdictionary.samasya.domain.history.model.HistoryItems
...
class HistoryEnglishFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val width = size.x
        if(lvExp == null) Log.i("check_expandable","null value")
