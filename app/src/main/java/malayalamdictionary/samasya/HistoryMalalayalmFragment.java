...
public class HistoryMalalayalmFragment extends Fragment {
                                ...
                                for (int i = (selected.size() - 1); i >= 0; i--) {
                                    ...
                                    if (!expanded) {
                                        if (selected.valueAt(i)) {
                                            ...
                                            try {
                                                Cursor cursor = databaseHelper.getWritableDatabase().rawQuery("delete From samasya_mal_history where MAL like '" + historyItems.getName() + "'", null);
                                                cursor.moveToFirst();
...
//                toolbar.setVisibility(View.VISIBLE);
    ...
    public void getDataFromDb() {
        ...
        try {
            myDbHelper2.open();
            Cursor cursor = myDbHelper2.getReadableDatabase().rawQuery("Select DISTINCT MAL From samasya_mal_history order by MAL asc", null);
...
// Get the screen's density scale
    ...
    private class HistoryTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            progress.dismiss();
            listAdapter = new HistoryAdapter(getActivity(), listDataHeader, listDataChild, false);
